...
const MenteeDashboard = () => {
  ...
  const upcomingSessions = [
    { id: 1, mentor: "John Doe", date: "2024-10-05", time: "14:00", status: 'scheduled' },
    { id: 2, mentor: "Jane Smith", date: "2024-10-07", time: "16:30", status: 'scheduled' },
  ];

  const recordedSessions = [
    { id: 1, title: "Introduction to React", date: "2024-09-28", watchedStatus: false },
    { id: 2, title: "Advanced JavaScript Concepts", date: "2024-09-25", watchedStatus: false },
  ];

  const suggestedMentors = [
    { id: 1, name: "Alice Johnson", specialization: "Web Development", rating: 4.8 },
    { id: 2, name: "Bob Williams", specialization: "Data Science", rating: 4.9 },
  ];
          ...
          <div className="space-y-4">
            {suggestedMentors.map((mentor) => (
              ...
              >
                ...
                <button className="mt-4 inline-block bg-yellow-500 text-white font-bold py-2 px-4 rounded-lg transition duration-300 ease-in-out hover:bg-yellow-600">
                  View Profile
                </button>
              </div>
            ))}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="bg-white p-8 rounded-lg shadow-lg max-w-lg w-full relative">
            ...
            <p className="text-sm text-gray-600 mb-6">
              {currentSession ? `Date: ${currentSession.date}, Time: ${currentSession.time || 'N/A'}` : ''}
            </p>
