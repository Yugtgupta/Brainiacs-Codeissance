...
// Make sure to import Bootstrap CSS
  ...
  return (
    <div className="container mt-5">
      ...
      <header className="d-flex justify-content-between align-items-center mb-4">
        <h1 className="display-4">Community Forum</h1>
        <Link to="/community-forum/add" className="btn btn-primary">
          Add Question
        </Link>
      </header>
            ...
            <div className="col-lg-4 col-md-6 mb-4" key={question.id}>
              <div className="card h-100 shadow-sm">
                ...
                <div className="card-footer bg-white border-top-0">
                  ...
                  <Link to={`/community-forum/${question.id}`} className="btn btn-outline-primary btn-sm">
                    View Question
                  </Link>
                </div>
              </div>
