...
Student.prototype.cleanUp = function () {
  ...
  this.data = {
    ...
    tutorIds: [], // save tutoir ids here
    scholarshipApplications: [],
    academicPerformance: this.data.academicPerformance, //passed/failed
    parentAnualIncome: Number(this.data.parentAnualIncome),
    forumPosts: this.data.forumPosts
  }
}

Student.prototype.login = async function () {
  let attemptedUser = await studentsCollection.findOne({
